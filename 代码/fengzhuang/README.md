## 反馈
- 如何调错
    1. 写一行打印一行，不要行云流水的写代码（~~视频中好多时候录的时候旁边会有一个小抄本，猜的~~ ）
        + https://www.zhihu.com/question/29776139/answer/45592854
    2. 报错如果是第60行，要在第55行到65行范围内找错误
    3. 确定是否是用域名或ip打开网页的
    4. 确定是否没有中文
    5. 查看console看一下有没有报
    6. 查看network数据是否返回正确
...
- 现象：
    + 一个知识点的细节强调多少次都没啥用，只有大家多写代码遇到了问题才慢慢的接受
